...
# Description: Unarchives a recording
...
if ($help || !$rec){
  print "* Unarchives a recording
  
Usage: 

somsds_unarchive_rec recid
...
## OPTIONS
  ...
  --filename      The archived filename, without file extension
                  By default /data/recordings/rec.tgz will be assumed
